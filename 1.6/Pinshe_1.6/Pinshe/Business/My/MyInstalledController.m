...
- (void)updateUserInfo {
    ...
    [self.httpService updateUserInfoWithName:self.userName phone:self.telphone address:self.address picImageChange:self.picImageChange picImage:self.picImage finished:^(NSDictionary *result, NSString *message) {
