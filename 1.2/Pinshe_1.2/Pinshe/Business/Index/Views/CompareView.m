...
- (void)beginAnimationWithLeftHeight:(CGFloat)leftHeight leftPercent:(float)leftPercent leftCenter:(CGFloat)leftCenter leftColor:(UIColor *)leftColor rightHeight:(CGFloat)rightHeight rightPercent:(float)rightPercent rightCenter:(CGFloat)rightCenter rightColor:(UIColor *)rightColor {
    ...
    //动画
    CABasicAnimation *leftLinePathAnimation = [self createAnimationWithKeyPath:@"strokeEnd" withFromeValue:@0.f toValue:@1.0f removeOnCompletion:YES];
    ...
    //动画
    CABasicAnimation *rightLinePathAnimation = [self createAnimationWithKeyPath:@"strokeEnd" withFromeValue:@0.f toValue:@1.0f removeOnCompletion:YES];
    ...
    //动画
    CABasicAnimation *pathAnimation = [self createAnimationWithKeyPath:@"strokeStart" withFromeValue:@0.f toValue:@1.0f removeOnCompletion:YES];
...
- (CABasicAnimation *)createAnimationWithKeyPath:(NSString *)keyPath withFromeValue:(NSNumber *)fromValue toValue:(NSNumber *)toValue removeOnCompletion:(BOOL)removeOnCompletion {
    //动画
