...
- (void)resetCompareDetailWith:(DetailVoteModel *)model {
    self.hidden = NO;
    ...
    self.supportNumLabel.text = [NSString stringWithFormat:@"%zd", model.vote_favorite];
