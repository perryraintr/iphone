...
- (void)requestProductDetail {
    [self.httpService detailRequestWithMethodName:@"product.a" currentId:[NSString stringWithFormat:@"pid=%zd", self.pid] finished:^(NSDictionary *result, NSString *message) {
        self.pinProductDetailModel = [PINProductDetailModel modelWithDictionary:result];
...
- (void)requestPostWithProduct {
    NSString *paramString = [NSString stringWithFormat:@"productid=%zd", self.pid];
    [self.httpService detailRequestWithMethodName:@"post.a" currentId:paramString finished:^(NSDictionary *result, NSString *message) {
...
- (void)detailSupportAction {
    NSString *paramString = [NSString stringWithFormat:@"prodid=%zd", self.pinProductDetailModel.product_guid];
