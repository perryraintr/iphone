...
- (void)resetDetailReplyCell:(CommentModel *)commentModel withReplyName:(NSString *)replyName {
    NSString *markString = [NSString stringWithFormat:@"%@：%@", commentModel.user_name, [commentModel.reply_name isEqualToString:replyName] ? @"" :  [NSString stringWithFormat:@"回复%@ ", commentModel.reply_name]];
