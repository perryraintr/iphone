...
#pragma mark - *********************字体*************************
#define FontNotSou(x)           [UIFont fontWithName:@"PingFang SC" size:x]
#define Font(x)                 [UIFont fontWithName:@"PingFang SC" size:FITWITH(x)]
#define FontBold(x)             [UIFont fontWithName:@"PingFang SC bold" size:FITWITH(x)]
