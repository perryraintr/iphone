...
@interface PublishRecommendController () <UIImagePickerControllerDelegate, UINavigationControllerDelegate, UITextViewDelegate, UITextFieldDelegate>
...
- (void)initUI {
    ...
    [super resetNavigationItemTiltView:view withTitleArray:@[@"比较", @"推荐", @"吐槽"] sel:@selector(titleViewAction:) delegate:self tag:101 isParentItem:NO isIndex:NO];
...
- (void)createPublishView {
    ...
    self.recommendTextFiled.returnKeyType = UIReturnKeyDone;
