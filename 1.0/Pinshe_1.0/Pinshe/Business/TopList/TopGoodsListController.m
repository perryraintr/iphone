...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.section == 0) { // 滚动图
        ...
        [xRCarouseView setPageColor:HEXCOLOR(pinColorGray) andCurrentPageColor:HEXCOLOR(pinColorOrange)];
...
- (CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout *)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath *)indexPath {
    if (indexPath.section == 0) {
        return CGSizeMake(SCREEN_WITH - FITHEIGHT(7) * 2, FITHEIGHT(133));
        ...
        if (self.productArray.count > 3) {
            if (self.expanded) { // 展开
                ...
                return CGSizeMake(SCREEN_WITH, FITHEIGHT(150));
            } else {
                if (indexPath.row == 3) {
                    return CGSizeMake(SCREEN_WITH, FITHEIGHT(44));
                }
...
- (UIEdgeInsets)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout *)collectionViewLayout insetForSectionAtIndex:(NSInteger)section {
    if (section == 0) {
        float edgeInset = FITHEIGHT(7);
        return UIEdgeInsetsMake(edgeInset, edgeInset, FITHEIGHT(4), edgeInset);
    } else if (section == 4) {
...
- (void)presentLoginVC {
    ...
    [paramsDic setObject:[NSNumber numberWithInteger:PinTopSceneType_Jouney] forKey:@"pinTopSceneType"];
