...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath {
    if (indexPath.section == 0) {
        CGFloat contentTextHeight = [NSString getTextHeight:(SCREEN_WITH - FITWITH(26) * 2) text:self.detailVote.vote_name withLineHiehtMultipe:1.0 fontSize:fFont14 isSuo:NO];
