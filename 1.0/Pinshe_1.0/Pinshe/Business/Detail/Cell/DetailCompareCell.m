...
- (void)layoutUI:(NSString *)voteTitle {
    ...
    CGFloat contentTextHeight = [NSString getTextHeight:(SCREEN_WITH - leftOffset * 2) text:voteTitle withLineHiehtMultipe:1.0 fontSize:fFont14 isSuo:NO];
...
- (void)resetRecommendCell:(IndexVote *)detailVote {
    ...
    self.describeLabel.attributedText = resetLineHeightMultiple(1.0, detailVote.vote_name);
