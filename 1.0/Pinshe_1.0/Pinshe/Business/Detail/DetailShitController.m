...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath {
    if (indexPath.section == 0) {
        CGFloat brandHeight = [NSString getTextHeight:(SCREEN_WITH - FITWITH(16) - 3) text:self.detailRecommendModel.post_name withLineHiehtMultipe:1.0 fontSize:fFont14 isSuo:NO];
        
        CGFloat descriptionHeight = [NSString getTextHeight:(SCREEN_WITH - FITWITH(27) * 2) text:self.detailRecommendModel.post_description withLineHiehtMultipe:1.0 fontSize:fFont14 isSuo:NO];
