...
/// 获取咖啡馆的余额信息
- (void)storeAmountRequestWithSid:(int)sid finished:(PINServiceCallback)finished failure:(PINServiceFailure)failure {
    
    NSString *paramStr = [NSString stringWithFormat:@"sid=%zd&page=all", sid];
