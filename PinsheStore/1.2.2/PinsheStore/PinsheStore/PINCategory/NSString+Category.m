...
// 日期转字符串
+ (NSString *)stringFromDateyyyy_MM_dd:(NSDate *)aDate
{
    NSString *dateString = [[NSString sharedDateFormatteryyyy_MM_dd] stringFromDate:aDate];
    return [dateString length] > 0?dateString:@"";
}

+ (NSDateFormatter *)sharedDateFormatteryyyy_MM_dd
{
    static NSDateFormatter *_dateFormatter = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
...
// 日期转字符串
+ (NSString *)stringFromDateShowyyyy_MM_dd:(NSDate *)aDate
{
    NSString *dateString = [[NSString sharedDateFormatterShowyyyy_MM_dd] stringFromDate:aDate];
    return [dateString length] > 0?dateString:@"";
}

+ (NSDateFormatter *)sharedDateFormatterShowyyyy_MM_dd
{
    static NSDateFormatter *_dateFormatter = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
