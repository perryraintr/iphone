...
- (void)buildingUI {
    self.nameLabel =  Building_UILabelWithSuperView(self.contentView, Font(fFont16), HEXCOLOR(pinColorBlack), NSTextAlignmentCenter, 0);
    self.nameLabel.text = @"请输入提现金额";
    
    self.signLabel = Building_UILabelWithSuperView(self.contentView, Font(fFont20), HEXCOLOR(pinColorBlack), NSTextAlignmentLeft, 0);
    self.signLabel.text = @"￥";
    ...
    self.sureButton.titleLabel.font = Font(fFont16);
